...
int main(int argc, char *argv[]) {
    ...
    if (argc > 3) {
        ...
        //Aqui e a parte da soma e subtracao. E segue o mesmo exemplo da multiplicaco -> realiza a conta, guarda na resposta e deixa o operando e os 2 numeros inutilizaveis
        for (int i = 1; i < argc; i++) {
            if (argv[i] == NULL)
                continue;
            printf("\n%f", resp);
