...
int main(){
    ...
    while(true){
        ...
        if (salario_base < 1518){ // verificacao que nao permite a entra de um salario abaixo de um salario minimo
    ...
    // Permite o usuario ter ou nao o vale transporte
    while(true){
         afirmacao = 0;
  ...
  if(salario_liquido < 1518.00){
      salario_liquido = 1518; // ajuste para um salario minimo
  }
...
// Vale alimentacão -> 464
    ...
    // Implementacao das porcentagens dentro das variaveis de acordo com os descontos
